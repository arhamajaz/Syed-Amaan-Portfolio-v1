...
export const GlassCard: React.FC<GlassCardProps> = ({ 
  ...
  // Smoothing springs for a premium, heavy feel
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div 
          className="absolute inset-0 z-0 bg-white/[0.03] backdrop-blur-[12px]" 
        ...
        {/* Content Layer */}
        <div className="relative z-30 transform-gpu w-full h-full" style={{ transform: "translateZ(20px)", willChange: "transform" }}>
          {children}
        </div>
      </motion.div>
    </div>
